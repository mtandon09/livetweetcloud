...
// This is the source from the example http://www.jasondavies.com/wordcloud/cloud.js?201402
    ...
    drag.enter().append("path")
        ...
        .call(d3.behavior.drag()
          .on("drag", function(d, i) {
            ...
            d = Math.max(-90, Math.min(90, d + delta - 90)); // remove this for 360å¡
            delta = to - from;
            if (i) {
              to = d;
